 ...
 * generated spec to {@code build/openapi/passport-service.json}. CI picks the
 * file up as an artifact (T40 acceptance criterion).
 */
@SpringBootTest
@AutoConfigureMockMvc
class OpenApiDocsTest extends AbstractPassportIntegrationTest {
    @Autowired
    private MockMvc mockMvc;

    @Test
    void exportsOpenApiJson() throws Exception {
        Path output = OpenApiDocsExporter.export(mockMvc, "passport-service");
