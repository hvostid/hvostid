...
public record QuestionnaireRequest(
        @NotNull(message = "Living space is required") LivingSpace livingSpace,

        @NotNull(message = "Living area is required") @Positive(message = "Living area must be positive")
        Integer livingArea,

        @NotNull(message = "Has yard is required") Boolean hasYard,

        @NotNull(message = "Has children is required") Boolean hasChildren,

        @PositiveOrZero(message = "Children age must be non-negative")
        Integer childrenAgeMin,

        @NotNull(message = "Has allergies is required") Boolean hasAllergies,

        @Size(max = 2000, message = "Allergy details too long")
        String allergyDetails,

        @NotNull(message = "Pet experience is required") PetExperience petExperience,
        ...
        @NotNull(message = "Work schedule is required") WorkSchedule workSchedule,
