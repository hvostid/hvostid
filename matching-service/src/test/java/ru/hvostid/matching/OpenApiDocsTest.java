 ...
 * generated spec to {@code build/openapi/matching-service.json}. CI picks the
...
class OpenApiDocsTest extends AbstractPostgresContainerTest {
    ...
    void exportsOpenApiJson() throws Exception {
        Path output = OpenApiDocsExporter.export(mockMvc, "matching-service");
