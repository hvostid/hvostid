...
class IntrospectionClientTest {
    ...
    @BeforeEach
    void setUp() {
        RestClient.Builder builder = RestClient.builder().baseUrl("http://localhost:8081/internal/auth/introspect");
    ...
    void activeToken_returnsPresent() {
        String responseBody =
                objectMapper.writeValueAsString(new IntrospectResponse(true, 42L, List.of(UserRole.BUYER.value())));
